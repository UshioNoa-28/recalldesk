...
class BasePublisher(abc.ABC):
    ...
    def __init__(self, *, session_factory: async_sessionmaker, policy: TaskPolicy) -> None:
        self._session_factory = session_factory
        self._policy = policy
        self._interval_seconds = policy.publish_interval_seconds
        self._batch_size = policy.publish_batch_size
